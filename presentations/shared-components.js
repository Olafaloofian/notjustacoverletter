...
export const CircleAnimation = (props) => {
    return (
        <div className="circle-container">
            ...
            <div className={props.color ? `line-red` : 'line'}><code>{'<CODE>'}</code></div>
...
export const AnimatedBackgroundSquare = (props) => {
    return (
        <div className="gradient-container-square" style={{ background: `linear-gradient(45deg, ${props.style[0]}, ${props.style[1]}, ${props.style[2]})`, backgroundSize: '400% 400%' }}>
            <div className="content">{props.content}</div>
        </div>
    )
}
...
export const FlipCard = (props) => {
    return (
        <div className='flipcard'>
            <div className={props.square ? 'flipcard-inner-square' : 'flipcard-inner'}>
                <div className={props.square ? "flipcard-front-square" : "flipcard-front"} style={{ background: props.style.frontBackground, color: props.style.frontColor }}>
                    {props.front}
                    <div className={props.square ? 'anchor-bottom-square' : 'anchor-bottom'} style={{ background: props.style.backBackground, color: props.style.backColor }}>{isLandscape ? 'Tap' : 'Hover'} to flip!</div>
                </div>
                <div className={props.square ? "flipcard-back-square" : "flipcard-back"} style={{ background: props.style.backBackground, color: props.style.backColor }}>
                    {props.back}
                    <div className={props.square ? 'anchor-bottom-square' : 'anchor-bottom'} style={{ background: props.style.frontBackground, color: props.style.frontColor }}>{isLandscape ? 'Tap away' : 'Hover away'} to flip!</div>
                </div>
            </div>
        </div>
    )
...
export const HiringResourcesAlt = (props) => {
    return (
        <div className="hiring-container">
            <div className="top-title-lowercase" style={{ color: props.primary, fontFamily: props.font }}>
                Thank you for taking the time to view this presentation. I hope you enjoyed a more interactive hiring experience! NotJustACoverLetter.com was designed and coded by me.
            </div>
            <div className="resources-container-square" style={{ background: props.primary }}>
                <div className="subtitle" style={{ color: props.secondary }}>
                    I'd love to keep in touch! For more resources about who I am and what I do, use the buttons below.
                </div>
                <div className='name'>
